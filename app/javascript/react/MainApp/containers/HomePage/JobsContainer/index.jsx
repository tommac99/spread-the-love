...
export const JobsContainer = () => {
  ...
  return (
    ...
    <Tab
      label="All" onClick={() => { changeIndex(event,"All") }}
    />
    <Tab
      label="Trade" onClick={() => { changeIndex(event,"Trade") }}
    />
    <Tab
      label="Paid" onClick={() => { changeIndex(event,"Paid") }}
    />
    <Tab
      label="Volunteering" onClick={() => { changeIndex(event,"Volunteering") }}
    />
  </Tabs>
  </Paper>
    </div>
